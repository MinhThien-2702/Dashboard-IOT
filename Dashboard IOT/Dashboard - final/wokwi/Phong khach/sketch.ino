...
const char* databaseURL="https://dht11-f8fe7-default-rtdb.firebaseio.com/phongkhach.json";
...
void loop(){
  ...
  Serial.println(digitalRead(led3));
    ...
    Serial.printf("canh bao: " , motionStateCurrent);



  // send data to firebase = protocol HTTP
  String data= String("{\"nhiet do\":") + String(nhietDo) + String(",\"do am\":") + String(doAm) + String(",\"chuyen dong\":") + String(motionStateCurrent) +String(",\"khoang cach\":") + String(distanceCm)+String(",\"lamp\":") + String(digitalRead(led3))+  String(",\"do sang\":") + String(kecerahan)+ String("}");
  HTTPClient http;
